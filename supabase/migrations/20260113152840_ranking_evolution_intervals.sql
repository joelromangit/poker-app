-- Function to get ranking evolution over monthly or yearly intervals
-- Accepts interval_type parameter: 'month' (default) or 'year'
-- Returns player rankings based on cumulative balance at each period
