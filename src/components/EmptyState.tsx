...
import { Club, Diamond, Heart, Plus, Spade } from "lucide-react";
  ...
  return (
    <div className="flex flex-col items-center justify-center py-16 px-4 animate-fade-in">
      ...
      <div className="flex items-center gap-3 mb-8">
        <div
          className="w-12 h-12 rounded-xl bg-background-card border border-border flex items-center justify-center animate-pulse"
      ...
      <p className="text-foreground-muted text-center max-w-sm mb-8">
        Registra tu primera partida de poker y lleva el control de las ganancias
        y pérdidas con tus amigos.
      </p>
