      ...
      <div className="flex items-start justify-between mb-3">
        ...
        <div className="flex items-center gap-1.5 ml-2 flex-shrink-0">
          {game.entry_eur != null && game.entry_eur > 0 && (
            <span
              className="text-xs font-bold text-accent bg-accent/15 px-2 py-1 rounded-full whitespace-nowrap"
              title={
                game.small_blind && game.big_blind
                  ? `Entrada ${Number(game.entry_eur.toFixed(2))}€ · ciegas ${game.small_blind}/${game.big_blind} fichas`
                  : undefined
              }
            >
